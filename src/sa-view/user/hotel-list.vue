	...
	<div class="vue-box">
		<div class="c-panel">
			...
			<el-table :data="dataList" >
				...
				<el-table-column label="酒店名称" prop="gsmc"></el-table-column>
				<el-table-column label="管理员名称" prop="username"> </el-table-column>
				<el-table-column label="管理员手机号" prop="phone" width="200px"></el-table-column>
				<el-table-column label="地址" prop="gsmc"> </el-table-column>
				...
				<el-table-column label="是否推荐" prop="ycj">
					<template slot-scope="s">
						...
						<span style="color: #999;" v-if="s.row.status==1">推荐</span>
					</template>
				</el-table-column>
