	...
	<div class="vue-box">
		<div class="c-panel">
			...
			<el-table class="data-table" :data="dataList">
				...
				<el-table-column label="职位" prop="create_username"></el-table-column>
				<el-table-column label="邮箱" prop="hotelType"></el-table-column>
				<el-table-column label="名片" prop="see_count">
					<template slot-scope="{row}">
						<img :src="row.avatar" @click="sa.showImage(row.avatar, '400px', '400px')"
